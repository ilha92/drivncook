    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarContent">
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <?php if ($isConnected): ?>
                    <li class="nav-item">
                        <a class="nav-link" href="/public/admin/dashboard.php">Dashboard</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/public/admin/approvisionnements.php">Approvisionnement</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/public/admin/ventes.php">Ventes</a>
                    </li>
                <?php endif; ?>
            </ul>
            ...
            <div class="d-flex gap-2 align-items-center">
                ...
                <?php if ($isConnected): ?>
                    <!-- Profil -->
                    <a href="/public/admin/franchises.php" class="btn btn-success btn-sm">
                         Profil Franchisé
                    </a>
